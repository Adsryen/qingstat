...
export async function loader({ context, request }: LoaderFunctionArgs) {
    ...
    return {
        countsByProperty: await analyticsEngine.getCountByDeviceModel(
            site,
            interval,
            tz,
            filters,
...
export const DeviceModelCard = ({
    ...
    return (
        <PaginatedTableCard
            siteId={siteId}
            interval={interval}
            columnHeaders={["Device Model", "Visitors"]}
            dataFetcher={useFetcher<typeof loader>()}
            loaderUrl="/resources/device-model"
            filters={filters}
            onClick={(deviceModel) =>
