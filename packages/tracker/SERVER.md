...
The `@qingstat/tracker` package now supports server-side usage through the `/server` module export.
...
```typescript
import * as Qingstat from "@qingstat/tracker/server";

// Initialize the tracker
Qingstat.init({
    siteId: "your-site-id",
    reporterUrl: "https://your-Qingstat-domain.com/collect",
...
```typescript
import * as Qingstat from "@qingstat/tracker"; // Client-side
import * as QingstatServer from "@qingstat/tracker/server"; // Server-side
```
